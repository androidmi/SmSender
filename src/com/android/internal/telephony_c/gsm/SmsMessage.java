package com.android.internal.telephony_c.gsm;
/*
...
import static android.util_c.SmsConstants.ENCODING_16BIT;
import static android.util_c.SmsConstants.ENCODING_7BIT;
import static android.util_c.SmsConstants.ENCODING_8BIT;
import static android.util_c.SmsConstants.ENCODING_KSC5601;
import static android.util_c.SmsConstants.ENCODING_UNKNOWN;
import static android.util_c.SmsConstants.MAX_USER_DATA_BYTES;
import static android.util_c.SmsConstants.MAX_USER_DATA_BYTES_WITH_HEADER;
import static android.util_c.SmsConstants.MAX_USER_DATA_SEPTETS;
...
import android.telephony_c.GsmSmsAddress;
import android.telephony_c.HexDump;
import android.telephony_c.IccUtils;
import android.telephony_c.PhoneNumberUtils;
import android.util.Log;
import android.util_c.EncodeException;
import android.util_c.GsmAlphabet;
import android.util_c.GsmAlphabet.TextEncodingDetails;
import android.util_c.Rlog;
import android.util_c.SmsConstants.MessageClass;
import android.util_c.Time;

import com.android.internal.telephony_c.SmsHeader;
import com.android.internal.telephony_c.SmsMessageBase;
...
public class SmsMessage extends SmsMessageBase {
    ...
    public static SubmitPdu getSubmitPdu(String scAddress,
        ...
        Log.i(LOG_TAG, "message0:" + message);
        ...
        Log.i(LOG_TAG, "bo:" + HexDump.bytesToHexString(bo.toByteArray()));
        Log.i(LOG_TAG, "message1:" + message);
        ...
        Log.i(LOG_TAG, "userData:" + HexDump.bytesToHexString(userData));
        if (encoding == ENCODING_7BIT) {
        ...
        Log.i(LOG_TAG, "encoding:" + encoding);
        Log.i(LOG_TAG, "write not ok");
    ...
    private static class PduParser {
        ...
        String getSCAddress() {
            ...
            if (len == 0) {
                ...
                // SC address
                try {
                	Rlog.d(LOG_TAG, "SC address len: "+len);
        ...
        GsmSmsAddress getAddress() {
            ...
            System.out.println("addressLen:" + addressLength);
            System.out.println("lengthBytes:" + lengthBytes);
            try {
...
//            return time.toMillis(true) - (timezoneOffset * 15 * 60 * 1000);
    ...
    private void parseSmsDeliver(PduParser p, int firstByte) {
        ...
        if (VDBG) Rlog.v(LOG_TAG, "SMS mReplyPathPresent : " + mReplyPathPresent);
        mOriginatingAddress = p.getAddress();

        if (mOriginatingAddress != null) {
            if (VDBG) Rlog.v(LOG_TAG, "SMS originating address: "
                    + mOriginatingAddress.address+" ton : " + mOriginatingAddress.ton);
        }
    ...
    private void parseUserData(PduParser p, boolean hasUserDataHeader) {
        ...
        if (VDBG) Rlog.v(LOG_TAG, "SMS message encodingType: '" + encodingType + "'");
        switch (encodingType) {
